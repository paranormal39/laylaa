...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      mint: (...args_1) => {
        ...
        const to_0 = args_1[2];
        const metadataCID_0 = args_1[3];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('mint',
                                     'argument 1 (as invoked from Typescript)',
                                     'nft.compact line 26 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(tokenId_0).concat(_descriptor_4.toValue(to_0).concat(_descriptor_5.toValue(metadataCID_0))),
      ...
      ownerOfToken: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`ownerOfToken: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const tokenId_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('ownerOfToken',
                                     'argument 1 (as invoked from Typescript)',
                                     'nft.compact line 35 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(tokenId_0.buffer instanceof ArrayBuffer && tokenId_0.BYTES_PER_ELEMENT === 1 && tokenId_0.length === 32)) {
        ...
        const result_0 = this._ownerOfToken_0(context,
                                              partialProofData,
                                              tokenId_0);
      ...
      transfer: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_4.toValue(to_0).concat(_descriptor_0.toValue(tokenId_0)),
      ...
      approve: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_4.toValue(spender_0).concat(_descriptor_0.toValue(tokenId_0)),
            alignment: _descriptor_4.alignment().concat(_descriptor_0.alignment())
          },
          output: undefined,
          publicTranscript: [],
      ...
      transferFrom: (...args_1) => {
        ...
        const contextOrig_0 = args_1[0];
        const fromOwner_0 = args_1[1];
        const to_0 = args_1[2];
        const tokenId_0 = args_1[3];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('transferFrom',
                                     'argument 1 (as invoked from Typescript)',
                                     'nft.compact line 63 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(fromOwner_0) === 'object' && typeof(fromOwner_0.is_left) === 'boolean' && typeof(fromOwner_0.left) === 'object' && fromOwner_0.left.bytes.buffer instanceof ArrayBuffer && fromOwner_0.left.bytes.BYTES_PER_ELEMENT === 1 && fromOwner_0.left.bytes.length === 32 && typeof(fromOwner_0.right) === 'object' && fromOwner_0.right.bytes.buffer instanceof ArrayBuffer && fromOwner_0.right.bytes.BYTES_PER_ELEMENT === 1 && fromOwner_0.right.bytes.length === 32)) {
          __compactRuntime.typeError('transferFrom',
                                     'argument 1 (argument 2 as invoked from Typescript)',
                                     'nft.compact line 63 char 1',
                                     'struct Either<is_left: Boolean, left: struct ZswapCoinPublicKey<bytes: Bytes<32>>, right: struct ContractAddress<bytes: Bytes<32>>>',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_4.toValue(fromOwner_0).concat(_descriptor_4.toValue(to_0).concat(_descriptor_0.toValue(tokenId_0))),
    ...
    this.impureCircuits = {
      ...
      ownerOfToken: this.circuits.ownerOfToken,
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('ownerOfToken', new __compactRuntime.ContractOperation());
  ...
  _mint_0(context, partialProofData, tokenId_0, to_0, metadataCID_0) {
    const id_0 = tokenId_0;
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(id_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_5.toValue(metadataCID_0),
  ...
  _ownerOfToken_0(context, partialProofData, tokenId_0) {
    const id_0 = tokenId_0;
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
  ...
  _approve_0(context, partialProofData, spender_0, tokenId_0) {
    const id_0 = tokenId_0;
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
  ...
  _transferFrom_0(context, partialProofData, fromOwner_0, to_0, tokenId_0) {
    const id_0 = tokenId_0;
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       ...
                                                                                       { popeq: { cached: true,
                                                                                                  result: undefined } }]).value),
                            'nft: nonexistent token');
    const owner_0 = _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                              partialProofData,
                                                                              [
                                                                               { dup: { n: 0 } },
                                                                               { idx: { cached: false,
                                                                               ...
                                                                               { popeq: { cached: false,
                                                                                          result: undefined } }]).value);
    __compactRuntime.assert(this._equal_2(owner_0, fromOwner_0),
                            'nft: from is not the owner');
    const caller_0 = this._left_0(this._ownPublicKey_0(context, partialProofData));
    const isOwner_0 = this._equal_3(owner_0, caller_0);
    const isApproved_0 = _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                   partialProofData,
                                                                                   [
                                                                                    { dup: { n: 0 } },
                                                                                    { idx: { cached: false,
                                                                                    ...
                                                                                    { popeq: { cached: true,
                                                                                               result: undefined } }]).value)
                         &&
                         this._equal_4(_descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                 partialProofData,
                                                                                                 [
                                                                                                  { dup: { n: 0 } },
                                                                                                  { idx: { cached: false,
                                                                                                  ...
                                                                                                  { popeq: { cached: false,
                                                                                                             result: undefined } }]).value),
                                       caller_0);
    __compactRuntime.assert(isOwner_0 || isApproved_0,
                            'nft: caller not authorized');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
