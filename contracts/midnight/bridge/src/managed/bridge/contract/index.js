...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      setPaused: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(paused_0),
      ...
      redeemBurn: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`redeemBurn: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const burnTxHash_0 = args_1[1];
        const metadataCID_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('redeemBurn',
                                     'argument 1 (as invoked from Typescript)',
                                     'bridge.compact line 39 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(burnTxHash_0.buffer instanceof ArrayBuffer && burnTxHash_0.BYTES_PER_ELEMENT === 1 && burnTxHash_0.length === 32)) {
          __compactRuntime.typeError('redeemBurn',
                                     'argument 1 (argument 2 as invoked from Typescript)',
                                     'bridge.compact line 39 char 1',
                                     'Bytes<32>',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(burnTxHash_0).concat(_descriptor_2.toValue(metadataCID_0)),
        ...
        const result_0 = this._redeemBurn_0(context,
                                            partialProofData,
                                            burnTxHash_0,
                                            metadataCID_0);
      ...
      isRedeemed: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`isRedeemed: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const burnTxHash_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('isRedeemed',
                                     'argument 1 (as invoked from Typescript)',
                                     'bridge.compact line 48 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(burnTxHash_0.buffer instanceof ArrayBuffer && burnTxHash_0.BYTES_PER_ELEMENT === 1 && burnTxHash_0.length === 32)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(burnTxHash_0),
        ...
        const result_0 = this._isRedeemed_0(context,
                                            partialProofData,
                                            burnTxHash_0);
        partialProofData.output = { value: _descriptor_1.toValue(result_0), alignment: _descriptor_1.alignment() };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      metadataOfBurn: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`metadataOfBurn: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const burnTxHash_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('metadataOfBurn',
                                     'argument 1 (as invoked from Typescript)',
                                     'bridge.compact line 52 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(burnTxHash_0.buffer instanceof ArrayBuffer && burnTxHash_0.BYTES_PER_ELEMENT === 1 && burnTxHash_0.length === 32)) {
        ...
        const result_0 = this._metadataOfBurn_0(context,
                                                partialProofData,
                                                burnTxHash_0);
    ...
    this.impureCircuits = {
      ...
      redeemBurn: this.circuits.redeemBurn,
      isRedeemed: this.circuits.isRedeemed,
      metadataOfBurn: this.circuits.metadataOfBurn
    };
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('redeemBurn', new __compactRuntime.ContractOperation());
    state_0.setOperation('isRedeemed', new __compactRuntime.ContractOperation());
    state_0.setOperation('metadataOfBurn', new __compactRuntime.ContractOperation());
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_9.toValue(2n),
                                                                                              alignment: _descriptor_9.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(paused_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    return [];
  }
  _redeemBurn_0(context, partialProofData, burnTxHash_0, metadataCID_0) {
    __compactRuntime.assert(!_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        { dup: { n: 0 } },
                                                                                                 ...
                                                                                                 path: [
                                                                                                        { tag: 'value',
                                                                                                          value: { value: _descriptor_9.toValue(3n),
                                                                                                                   alignment: _descriptor_9.alignment() } }] } },
                                                                                        { push: { storage: false,
                                                                                                  value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(burnTxHash_0),
                                                                                                                                               alignment: _descriptor_0.alignment() }).encode() } },
                                                                                        'member',
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value),
                            'bridge: burn already redeemed');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(burnTxHash_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(metadataCID_0),
  ...
  _isRedeemed_0(context, partialProofData, burnTxHash_0) {
  ...
  _metadataOfBurn_0(context, partialProofData, burnTxHash_0) {
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
    ...
    return _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                     ...
                                                                     [
                                                                      ...
                                                                      { idx: { cached: false,
                                                                               ...
                                                                               path: [
                                                                                      { tag: 'value',
                                                                                        value: { value: _descriptor_0.toValue(burnTxHash_0),
                                                                                                 alignment: _descriptor_0.alignment() } }] } },
                                                                      { popeq: { cached: false,
                                                                                 result: undefined } }]).value);
  }
